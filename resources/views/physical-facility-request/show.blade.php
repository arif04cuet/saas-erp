@extends('hm::Modules.HM.Resources.views.layouts.master')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        ...
                        @if($type == 'booking')
                            @include('hm::Modules.HM.Resources.views.booking-request.partials.modal.request-forward', ['forwardToUsers' => $forwardToUsers, 'roomBookingId' => $roomBooking->id])
                        @endif
