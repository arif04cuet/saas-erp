...
@section('title', trans('doptor.title.edit'))
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><i class="ft-tag black"></i> {{trans('doptor.title.edit')}}</h4>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                @include('doptor.partials.edit_form',['doptor'=>$doptor,'module' => $module])
                            </div>
                        </div>
                    </div>
                </div>
