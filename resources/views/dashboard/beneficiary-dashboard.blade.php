                    ...
                    <div class="app-main__inner">
                                ...
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-subheading">Current + Completed</div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Running Training</div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Completed Trainings</div>
                                            <div class="widget-subheading"></div>
                                        </div>
                                        <div class="widget-content-right">
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">IGA (Outsourcing) Training Course</div>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    {{-- <button type="button" class="btn btn-info btn-sm">Attandance</button> --}}

                                                    <a target="__blank" class="btn btn-info btn-sm" href="{{asset('images/1656945086118.JPEG')}}">Attandance</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">IGA (Mobile Servicing) Training Course</div>
                                                                
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">01-05-2022</td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a target="__blank" class="btn btn-success btn-sm" href="{{asset('images/certificate.jpeg')}}">Certificate</a>
                                                    <a target="__blank" class="btn btn-info btn-sm" href="{{asset('images/1656945086118.JPEG')}}">Attandance</a>
                                                    <a target="__blank" class="btn btn-danger btn-sm" href="{{asset('images/release_order.png')}}">Release Order</a>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">Accounting and Auditing Training Course</div>
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">IGA (Electrical) Training Course</div>
                                                                
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">01-10-2020</td>
