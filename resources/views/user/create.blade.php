                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-form"><i class="ft-user"></i> {{trans('user-management.create_user_title')}}</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            {{-- <div class="form-group">
                                                ...
                                                {{ Form::select("doptors", $doptors, null,
                                                   ["class"=>"form-control form-control-sm select2", "id"=>"doptor_id",
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {{ Form::select("roles", $roles, null, ["class"=>"form-control form-control-sm select2", "id"=>"roles",
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a class="master btn btn-warning mr-1" role="button" href="{{route('users.index')}}">
