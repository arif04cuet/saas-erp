                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><i class="las la-list black"></i> {{ trans('user-management.user_list_page_title') }}</h4>
                                        ...
                                        @foreach ($users as $key => $user)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('impersonate', $user->id) }}" class="master btn btn-primary" title="Impersonate">
                                                            <i class="ft-user white"></i>
                                                        </a>
                                                        <a href="{{ route('users.show', $user->id) }}" class="master btn btn-info" title="{{trans('labels.details')}}">
                                                            <i class="ft-eye white"></i>
                                                        </a>
                                                        <a href="{{ route('users.edit', $user->id) }}" class="master btn btn-success" title="{{trans('labels.edit')}}">
