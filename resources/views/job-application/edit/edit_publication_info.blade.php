                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".author_name") ? ' error' : '' }}">
                                        ...
                                        {{ Form::text('author_name',  $publication['author_name'], ['class' => 'form-control', 'placeholder' => 'eg. John Doe',
                                         'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".publication_company") ? ' error' : '' }}">
                                        ...
                                        ['class' => 'form-control', 'placeholder' => 'eg. IEEE', 'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".source_link") ? ' error' : '' }}">
                                        ...
                                        <input type="url" name="source_link" value="{{$publication['source_link']}}" class="form-control" required
                                               ...
                                               data-validation-required-message = "{{trans('labels.This field is required')}}">
                                        {{--{{ Form::url('source_link',  $publication['source_link'], ['class' => 'form-control',--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ['class' => 'form-control', 'placeholder' => 'eg. John Doe', 'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('publication_title', trans('hrm::publication.publication_title'), ['class' => 'required']) }}
                                        {{ Form::text('publication_title', $publication->publication_title, ['class' => 'form-control',
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('publication_company', trans('hrm::publication.publication_company'), ['class' => 'required']) }}
                                        {{ Form::text('publication_company',  $publication->publication_company, ['class' => 'form-control', 'placeholder' => 'eg. IEEE',
                                        'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                    </div>
                                </div>
