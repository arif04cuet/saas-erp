...
@section('title', trans('tms::inventory.tms_inventory_location'))
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('tms::inventory.tms_inventory_location') @lang('labels.list')</h4>
                                ...
                                <table class="location-list-table table table-bordered ">
                                    ...
                                    @foreach($inventoryLocations as $inventoryLocation)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('tms-inventory-locations.show', $inventoryLocation->id) }}">
