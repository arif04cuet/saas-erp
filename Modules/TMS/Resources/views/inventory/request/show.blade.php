...
@section('title', trans('tms::inventory.inventory_request'))

@section('content')
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">@lang('tms::inventory.inventory_request') @lang('labels.show')</h4>
            ...
            <div class="heading-elements mt-2" style="margin-right: 10px;">
                <a href="{{ route('tms-inventory-request.index') }}" class="btn btn-primary btn-sm">
