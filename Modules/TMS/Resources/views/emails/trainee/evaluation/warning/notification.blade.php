...
<table border="0" cellpadding="0" cellspacing="0" class="body"
    ...
    <tr style="background: none;">
        <td style="font-family: sans-serif; font-size: 16px; vertical-align: top;">@lang('tms::schedule.warning.description')</b>
            <br></td>
    </tr>
    <tr>
        <td class="container"
            ...
            <div class="content"
                ...
                @if(count($data))
                    @foreach($data as $key => $schedules)
                        <h3 style="text-align: center; font-size: 20px;">{{ $schedules[0]['course_name'] }}</h3>
                        <table class="text-center table-bordered" style="border: 1px solid #000000; border-collapse: collapse;" border="1">
                            ...
                            <tr style="border: 1px solid #000000;">
                                ...
                                <th style="padding: 5px; background: lightgrey;">@lang('tms::schedule.evaluate.last_time')</th>
                                <th style="padding: 5px; background: lightgrey;">@lang('labels.action')</th>
                            </tr>
                            </thead>
                            ...
                            @if(count($schedules))
                                @foreach($schedules as $schedule)
                                    <tr style="border: 1px solid #000000;">
                                        ...
                                        <td style="padding: 5px;">{{ $schedule['evaluation_expiry'] }}</td>
                                        <td style="padding: 5px;">
                                            <a class="btn btn-sm btn-primary" href="{{ $schedule['evaluation_url'] }}">
                                                @lang('tms::schedule.evaluate.button.title')
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <tr style="background: none; margin-top: 10px;">
        <td style="font-family: sans-serif; font-size: 16px; vertical-align: top; horiz-align: center;">
        </td>
    </tr>
    <tr style="background: none; margin-top: 10px;">
        <td style="font-family: sans-serif; font-size: 16px; vertical-align: top;">
            @lang('labels.thank_you'), </td>
    </tr>
    <tr style="background: none;">
        <td style="font-family: sans-serif; font-size: 16px; vertical-align: top;">
            @lang('labels.bangladesh_rural_development_academy') (@lang('labels.BARD ERP'))</td>
    </tr>
</table>
</body>
</html>
