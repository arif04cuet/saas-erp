@component('tms::trainee.partials.components.create_layout', ['trainee' => $trainee])
    {!! Form::open(['url' =>  route('trainee.trainee-type.store', $trainee->id),
    ...
    <div class="form-body">
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {{-- <div class="skin skin-flat"> --}}
                                        {!! Form::radio(
                                            'trainee_type', 'doptor', false, ['class' => 'required',
                ...
                <!------- Sumiti Member ------------>
                <div class="association-member border p-1">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br/>
                                {!! Form::text('org_id', old('org_id'), ['class' => 'form-control form-control-sm required' . ($errors->has('org_id') ? ' is-invalid' : ''), 'data-msg-required' => Lang::get('labels.This field is required'), 'data-rule-maxlength' => 50, 'data-msg-maxlength'=>Lang::get('labels.At most 50 characters'),
                                    'data-rule-no-white-space' => '^(\s|\S)*(\S)+(\s|\S)*$',]) !!}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div id="org_member_join_date-container" class="date-container"></div>
                                {!! Form::text(
                                    'org_member_join_date',
                                    isset($traineeType) ? $traineeType->org_member_join_date : null,
                                    [
                                    'placeholder' => 'pick date',
                                    'id' => 'org_member_join_date',
                ...
                <!----------- Sumiti Member End ------------->
                <div class="kormokarta-form border p-1">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br/>
                                {!! Form::text('doptor_service_id', old('doptor_service_id'), ['class' => 'form-control form-control-sm required' . ($errors->has('doptor_service_id') ? ' is-invalid' : ''), 'data-msg-required' => Lang::get('labels.This field is required'), 'data-rule-maxlength' => 50, 'data-msg-maxlength'=>Lang::get('labels.At most 50 characters'),
                                    'data-rule-no-white-space' => '^(\s|\S)*(\S)+(\s|\S)*$',
                                'disabled' => 'true'
                                ]) !!}
