@if($langPreference == $langOptions['only_english'])
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('fathers_name', old('fathers_name') ?? optional($trainee->generalInfos)->fathers_name,[
...
@elseif($langPreference == $langOptions['only_bangla'])
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!!Form::text('fathers_name_bn', old('fathers_name_bn') ?? optional($trainee->generalInfos)->fathers_name_bn,[
