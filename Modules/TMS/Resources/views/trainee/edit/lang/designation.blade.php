@if($langPreference == $langOptions['only_english'])
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('designation', old('designation') ?? optional($trainee->services)->designation, [
...
@elseif($langPreference == $langOptions['only_bangla'])
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('designation_bn', old('designation_bn')  ?? optional($trainee->services)->designation_bn, [
...
@else
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="designation" class="required">@lang('tms::training.designation') : </label>
            {!! Form::text('designation', old('designation') ?? old('designation') ?? optional($trainee->services)->designation, [
                'class' => 'form-control required' . ($errors->has('designation') ? ' is-invalid' : ''),
                'data-msg-required' => Lang::get('labels.This field is required'),
                'placeholder' => 'teacher',
                'data-rule-regex-en' => '^([\x3Aa-zA-Z0-9\u002D\u0020])+$',
