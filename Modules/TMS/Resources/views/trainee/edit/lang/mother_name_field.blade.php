@if($langPreference == $langOptions['only_english'])
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            old('mothers_name') ?? optional($trainee->generalInfos)->mothers_name,
            [
...
@elseif($langPreference == $langOptions['only_bangla'])
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('mothers_name_bn', old('mothers_name_bn') ?? optional($trainee->generalInfos)->mothers_name_bn, [
