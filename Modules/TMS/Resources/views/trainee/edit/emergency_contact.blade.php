@component('tms::trainee.partials.components.edit_layout', [
    ...
    {!! Form::open(['url' =>  route('trainee.contact.update', $trainee->id),
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('name', optional($trainee->emergencyContacts)->name, ['class' => 'form-control required' . ($errors->has('name') ? ' is-invalid' : ''), 'data-msg-required' => Lang::get('labels.This field is required'), 'placeholder' => 'Abdul Mutaleb', 'data-rule-maxlength' => 50, 'data-msg-maxlength'=>Lang::get('labels.At most 50 characters'), 'data-rule-no-white-space' => '^(\s|\S)*(\S)+(\s|\S)*$',]) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text(
                                'mobile_no',
                                convert_number(optional($trainee->emergencyContacts)->mobile_no),
                                [
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('relation', optional($trainee->emergencyContacts)->relation, ['class' => 'form-control required' . ($errors->has('relation') ? ' is-invalid' : ''), 'data-msg-required' => Lang::get('labels.This field is required'), 'placeholder' => 'Father', 'data-rule-maxlength' => 50, 'data-msg-maxlength'=>Lang::get('labels.At most 50 characters'), 'data-rule-no-white-space' => '^(\s|\S)*(\S)+(\s|\S)*$',]) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        {!! Form::textarea(
                            'contact_address',
                            optional($trainee->emergencyContacts)->contact_address,
                            [
                                'id' => '',
                                'data-msg-required' => Lang::get('labels.This field is required'),
