...
@section('title', trans('tms::training_head.edit'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"
                        id="basic-layout-form">@lang('tms::training_head.edit')</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body preduce">
                        {!! Form::open(['route' =>  ['training-head.update',$trainingHead], 'class' => 'form wizard-circle training-head-form', 'novalidate', 'method' => 'post']) !!}
                        @method('put')
                        @include('tms::training-head.form',['page'=>'edit'])
