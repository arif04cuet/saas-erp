...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {{ Form::text('uid', null, ['class' => 'form-control form-control-sm']) }}
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{ Form::textarea('course_detail_bn', isset($course) ? $course->name_bn : null, [
        ...
        <div class="form-group">
            ...
            {{ Form::textarea('course_detail_en', isset($course) ? $course->name_bn : null, [
