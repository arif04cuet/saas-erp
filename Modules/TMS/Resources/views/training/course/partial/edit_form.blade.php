<div class="row">
    <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::text('start_date', isset($course) ? \Carbon\Carbon::parse($course->start_date)->format('j F Y') : null,
                    [
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::text('end_date',isset($course) ? \Carbon\Carbon::parse($course->end_date)->format('j F Y') : null,
                    [
                        'class' => 'form-control form-control-sm required dateField',
                        'data-msg-required' => trans('labels.This field is required'),
                        'placeholder' => 'Pick Date',
        ...
        <div class="form-group">
            <label for="" class="required">@lang('tms::trainee_type.title')</label>
            {{ Form::select('trainee_type', $trainee_types, isset($course) ? $course->trainee_type : null, [
                'class' => 'form-control form-control-sm required',
                'data-msg-required' => trans('labels.This field is required'),
                'placeholder' => trans('labels.select'),
                'select2'
            ...
            @if($errors->has('trainee_type'))
                <strong class="danger">{{ $errors->first('trainee_type') }}</strong>
            @endif
        </div>
        <div class="form-group">
            <h1 class="text-left"><label class="required">
            ...
            <div class="course-photo avatar-upload ml-0">
                ...
                @if($course->photo)
                    <div class="avatar-preview">
                        <div id="imagePreview"
                             style="background-image: url({{ url("/file/get?filePath=" .  $course->photo) }});">
                        </div>
                    </div>
                @else
                    <div class="avatar-preview">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {!! Form::text('registration_deadline', isset($course) ? \Carbon\Carbon::parse($course->registration_deadline)->format('j F Y') : null,
            [
                'class' => 'form-control form-control-sm required dateField',
                'data-msg-required' => trans('labels.This field is required'),
                'placeholder' => 'Pick Date',
...
@push('page-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#start_date, #end_date, #registration_deadline').pickadate({
                format: 'dd mmmm yyyy',
            });
