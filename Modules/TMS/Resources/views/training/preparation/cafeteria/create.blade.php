...
@section('title', trans('tms::training.preparation.cafeteria'))

@section('content')
    <div class="card">
        <div class="card-header">
            <h4>@lang('tms::training.preparation.cafeteria') - <a
                ...
                <div data-repeater-list="hostels">
                    <div data-repeater-item>
                        <form class="form row">
                            ...
                            <div class="form-group mb-1 col-sm-12 col-md-2">
                                <label for="hostel">@lang('tms::training.cafeteria')</label>
                                <br>
                                @php
                                    $cafeteriaDropDowns = [];
                                    foreach (range(1, 3) as $number) {
                                        array_push($cafeteriaDropDowns, trans('tms::training.cafeteria') . " $number");
                                    }
                                @endphp
                                {{ Form::select('cafeteria', $cafeteriaDropDowns, null, [
                                    'class' => 'select2',
