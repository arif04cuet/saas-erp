            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"
                            id="basic-layout-form">@lang('tms::training_type.edit')</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body preduce">
                            {{-- {{ dd($trainingCategory) }} --}}
                            {!! Form::open(['route' =>  ['training-category-update', $trainingCategory], 'class' => 'form wizard-circle training-category-form', 'novalidate', 'method' => 'post']) !!}
                            @method('put')
                            @include('tms::training.category.form',['trainingCategory'=>$trainingCategory,'categoriesDropdown'=>$categoriesDropdown,'page'=>'edit'])
