                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header course-list-title">
                            <h2 class="card-title text-center">{{ trans('tms::training.training_list') }}</h2>
                                                ...
                                                @foreach ($trainings as $training)
                                                    <li class="item">
                                                        <div class="img-box">
                                                            ...
                                                            @else
                                                                <img src="{{ url('/file/get?filePath=' . $training->photo) }}"
                                                                    class="img-fluid img-responsive">
                                                            @endif
                                                        </div>
                                                        <div class="course-time-area">
                                                            ...
                                                            <div class="course-enroll">
                                                                <a href="{{ route('trainings.trainees.registrations.check', ['training' => $training]) }}"
                        ...
                        <ul class="inner-container list-unstyled">
                            ...
                            <li class="item">
                                <div class="img-box"><img
                                        src="{{ asset('images/training/programm/item-2.png') }}">
                                </div>
                                <div class="course-time-area">
                                    <h4 class="mt-2">আমিনশীপ</h4>
                                    <p class="mb-0"><b>নিবন্ধকরণের সময়সীমা</b> : ১৩-০৪-২০২২</p>
