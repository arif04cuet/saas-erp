        ...
        <div class="col-md-8 offset-2">
            <fieldset>
                <div class="form row">
                    ...
                    {!! Form::hidden('research_request_id', $researchDetail->research_request_id) !!}
                    {!! Form::hidden('id', $researchDetail->id) !!}
                    <div class="form-group mb-1 col-sm-12 col-md-12">
                        <label class="required">{{ trans('labels.title') }}</label>
                        <br>
                        {!! Form::text('title', $page == 'create' ? old('title') : $researchDetail->title, ['class' => 'form-control required' . ($errors->has('title') ? ' is-invalid' : ''), 'data-msg-required' => Lang::get('labels.This field is required'), 'placeholder' => 'Title', 'data-rule-maxlength' => 100, 'data-msg-maxlength'=>Lang::get('labels.At most 100 characters')]) !!}
