                                ...
                                @if($isValidUser)
                                    <div class="col-md-12">
                                        ...
                                        @if(!is_null($ruleDesignations))
                                            <div class="">
                                                <div
                                                    class="form-group {{ $errors->has('designation_id') ? 'error' : '' }}">
                                                    ...
                                                    <select name="designation_id" class="form-control">
                                                        ...
                                                        @foreach($ruleDesignations as $ruleDesignation)
                                                            <option
                                                                value="{{$ruleDesignation->designation_id}}">
                                                                {{   optional($ruleDesignation->getDesignation)->name?? trans('labels.not_found') }}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <a href="{{ route('research-proposal-submission.index') }}"
                                           class="btn btn-warning"><i
                                                class="ft-x white"></i> @lang('rms::approved-proposal.links.cancel.title')
                                        </a>
                                        @if(auth()->user()->employee->employeeDepartment->department_code == "RMS")
                                            <a href="{{ route('research-proposal-details.invitation.create', ['researchProposalSubmissionId' => $research->id]) }}"
