                    ...
                    <div class="card-content collapse show print-view">
                        <div class="card-body">
                            <div class="row">
                                ...
                                @if($isValidUser)
                                    <div class="col-md-12">
                                        {!! Form::open(['route' => [ 'research.share-feedback',$shareConversationId] , 'enctype' => 'multipart/form-data','id' => 'review_form', 'novalidate']) !!}
                                        <hr/>
                                        @if(!is_null($ruleDesignations))

                                            <div class="form-group {{ $errors->has('designation_id') ? 'error' : '' }}">
                                                <label for="designation_id">{{__('labels.share')}}</label>
                                        ...
                                        <div class="form-group {{ $errors->has('message') ? 'error' : '' }}">
                                            ...
                                            @if ($errors->has('message'))
                                                <div class="help-block">Maximum Range is 255 character</div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="review_buttons">
                                            ...
                                            @if($shareConversation->shareRuleDesignation->can_reject)
                                                <a href="{{ route('research-workflow-close-reviewer', [$workflowMasterId, $researchId]) }}"
