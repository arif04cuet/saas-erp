    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('mms::company.list')</h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                    <a href="{{route('medicine-company.create')}}" class="btn btn-primary btn-sm"><i
                            class="ft-plus white"></i> {{ trans('mms::company.registration') }}
                    </a>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="company-list-table table table-bordered">
                            ...
                            <tr>
                                ...
                                <th>@lang('mms::company.company')</th>
                                <th>@lang('mms::company.address')</th>
                                <th>@lang('mms::company.email')</th>
                                ...
                                <tr>
                                    ...
                                    <span class="dropdown">
                                        ...
                                        <span aria-labelledby="imsRequestList"
                                            ...
                                            <a href="{{ route('medicine-company.show', $info->id) }}"
                                               class="dropdown-item"><i class="ft-eye"></i> @lang('labels.details')</a>
                                            <div class="dropdown-divider"></div>
                                                <a href="{{ route('medicine-company.edit', $info->id) }}"
                                                   class="dropdown-item"><i class="ft-edit-2"></i> @lang('labels.edit')</a>
                                            <div class="dropdown-divider"></div>
                                                    {!! Form::open([
                                                        'method'=>'DELETE',
                                                        'url' => route('medicine-company.delete', $info->id),
