    ...
    <div class="prescription">
        <div class="card p-2">
            ...
            <div class="card-content ">
                <div class="card-body">
                    {!! Form::open(['route' =>  ['requisition.update',$medicine_info->id], 'class' => 'form', 'novalidate', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}

                    @include('mms::requisition.form.edit.form')
                    @include('mms::requisition.form.edit.medicineTable')
                    <div class="form-actions text-center">
                        <button type="submit" class="btn btn-primary">
                            <i class="ft-check-square "></i> {{ trans('labels.save') }}
                        </button>
                        <button class="btn btn-warning" type="button" onclick="window.location = '{{ route('inventories.prescribed.index') }}'">
            ...
            hide: function (deleteElement) {
                if(confirm("{{trans('labels.confirm_delete')}}")) {
                    ...
                    if (typeof id === "undefined") {
                        ...
                        let url = "{{ route('requisition.delete') }}";
