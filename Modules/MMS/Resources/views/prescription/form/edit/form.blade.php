        ...
        <div class="row">
            <div class="col-md-12" style="margin-bottom: 15px;">
                ...
                <div class="form-check-inline skin skin-flat">
                    ...
                    $page == "edit" ? $prescription->patient['type'] == "employee" ? true : false : true,
                    ['class' => 'required']) !!}
                    <label>@lang('mms::patient.type.employee')</label>
                </div>
                <div class="form-check-inline skin skin-flat">
                    {!! Form::radio('type', 'student',
                    $page == "edit" ? $prescription->patient['type']  == "student" ? true : false : false,
                    ['class' => 'required',]) !!}
                    <label>@lang('mms::patient.type.student')</label>
                </div>
                <div class="form-check-inline skin skin-flat">
                    {!! Form::radio('type', 'trainee',
                    $page == "edit" ? $prescription->patient['type']  == "trainee" ? true : false : false,
                    ['class' => 'required',]) !!}
                    <label>@lang('mms::patient.type.trainee')</label>
                </div>
                <div class="form-check-inline skin skin-flat">
                    {!! Form::radio('type', 'relative',
                    $page == "edit" ? $prescription->patient['type']  == "relative" ? true : false : false,
                    ['class' => 'required','id'=>'relative']) !!}
                    <label>@lang('mms::patient.type.relative')</label>
                </div>
                <div class="form-check-inline skin skin-flat">
                    {!! Form::radio('type', 'others',
                    $page == "edit" ? $prescription->patient['type']  == "others" ? true : false : false,
                    ['class' => 'required','id'=>'others']) !!}
            ...
            <div class="col-md-12 d-flex p-0" id="traineeInfo">
                <div class="col-md-6 training-list traineeInfo">
                    <div class="form-group">
                        <label class="form-label">@lang('mms::patient.training') {{trans('labels.name')}}</label>
                ...
                <div class="col-md-6 trainee-list traineeInfo">
                    <div class="form-group">
                        <label class="form-label">@lang('mms::patient.trainee')</label>

                        <select name="trainee_id" id="trainee_id" class="form-control  required employee-select"
            ...
            <div class="col-md-6 employee_name">
                <div class="form-group">
                    ...
                    {{-- {!! Form::select('employee_id', $employees, $page == "edit" ? $employees ? $prescription->employee_id : null : null,
                    ...
                    <select name="employee_id" class="form-control dropdown-employee-name employee-select"
                        ...
                        @foreach($employees2 as $depertment)
                            ...
                            @foreach($depertment['data'] as $key=>$depertment)
                                <option value="{{$key}}" @if($page=='edit' && !empty($employee->id))
            ...
            <div class="col-md-6 dropdown-div">
                <div class="form-group">
                    ...
                    {{-- {!! Form::select('employee', $employees, $page == "edit" ? $employees ? $prescription->id : null : null,
                    ...
                    <select name="employee" class="form-control dropdown-name required employee-select"
                        ...
                        @foreach($employees2 as $depertment)
                            ...
                            @foreach($depertment['data'] as $key=>$depertment)
                                <option value="{{$key}}"
                                        @if($page=='edit' && $prescription->patient['type'] !=='trainee')
                                        @if($employee->id==$key) selected @endif @endif>{{$depertment}}</option>
                            @endforeach
                        @endforeach
                    </select>
            ...
            <div class="col-md-6 txt-div" style="display: none">
                ...
                {!! Form::label('Name', trans('labels.name'),
                ['class' => 'form-label required']) !!}
                {!! Form::text('name', $page == "edit" ? $prescription->patient['name'] : null, ['class' =>
            ...
            <div class="col-md-6">
                ...
                ['class' => 'form-label required']) !!}
                {!! Form::text('patient_id', $page == "edit" ? $prescription->patient_id : null, ['class' =>
            ...
            <div class="col-md-6">
                ...
                {!! Form::number('age', $page == "edit" ? $prescription->age : null, ['class' =>
                'form-control required',
            ...
            <div class="col-md-6">
                ...
                ['class' => 'form-label required']) !!}
                {!! Form::text('mobile_no', $page == "edit" ? $prescription->mobile_no : null, ['class' =>
                'form-control required',
            ...
            <div class="col-md-6">
                ...
                {!! Form::text('relation', $page == "edit" ? $prescription->relation : null, ['class' =>
                'form-control',
            ...
            <div class="col-md-6">
                ...
                <div class="form-check-inline skin skin-flat">
                    {!! Form::radio('gender', 'male', $page == "edit" ? $prescription->gender == "male" ? true : false : '',
                    ['class' => 'required']) !!}
                    <label>@lang('mms::patient.male')</label>
                </div>
                <div class="form-check-inline skin skin-flat">
                    {!! Form::radio('gender', 'female', $page == "edit" ? $prescription->gender == "female" ? true : false : '',
                    ['class' => 'required',]) !!}
...
@push('page-js')
    <script>
        ...
        $(document).ready(function () {
            let type = "{{$prescription->patient['type']}}";
            if (document.getElementById("relative").checked == true || document.getElementById("others").checked == true) {
                $('.employee_name').show();
                $('.dropdown-employee-name').addClass('required');
            }
