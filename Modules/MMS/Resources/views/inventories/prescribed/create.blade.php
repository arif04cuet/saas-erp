        ...
        <div class="card p-2">
            <div class="card-header border-bottom pl-0">
                <h3 class="form-section">
                    <i class="ft-grid"></i> {{trans('mms::medicine_distribution.prescribed_medicine')}}
                </h3>
            </div>
            <div class="card-content">
                <div class="card-body">
                    {!! Form::open(['route' =>  ['inventories.prescribed.store'], 'class' => 'form form-prescribed', 'name'=>'prescribed','method' => 'post', 'enctype' => 'multipart/form-data']) !!}

                    @include('mms::inventories.prescribed.form.create.form')
                    @include('mms::inventories.prescribed.form.create.medicineTable')
