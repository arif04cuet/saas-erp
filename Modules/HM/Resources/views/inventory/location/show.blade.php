...
@section('title', trans('hm::hm_inventory.hm_inventory_location') . ' ' . trans('labels.details'))
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('hm::hm_inventory.inventory_location') @lang('labels.details')</h4>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('hm-inventory-locations.index') }}" class="btn btn-primary btn-sm">
                            <i class="ft-list white">
                                @lang('hm::hm_inventory.inventory_location') @lang('labels.list')
                            </i>
                        </a>
