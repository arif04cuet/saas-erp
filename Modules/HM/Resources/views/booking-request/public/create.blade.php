        ...
        <div class="row justify-content-center">
            ...
            @if (session('success'))
                    <div class="alert bg-success alert-dismissible mb-2" role="alert">
                        ...
                        <span style="color: black">{!! trans('hm::booking-request.flash_messages.create') !!}</span>
                        <hr>
                        <p class="text-center">
                            <a href="{{ route('public-booking-requests.create') }}"
                               class="btn btn-amber btn-accent-4 "
                               style="color: white"><b>@lang('hm::booking-request.create_booking_request')</b>
                            </a>
                        </p>
                    </div>
                @else
