                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px; border-bottom: 2px solid gray;">@lang('hm::bill.payment_details')
                                            ,</p>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <td style="margin-right: 20px">@lang('hm::bill.billing_time')</td>
                                                                <td> : {{ date('d/m/Y') }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="margin-right: 20px">@lang('hm::bill.bill_number')</td>
                                                                <td>{{ time() }}</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    : {{ trans('hm::booking-request.' . $roomBooking->booking_type) }}</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="due-amount">
                                                                    @php
                                                                        $dueAmount = $grandTotal - $roomBooking->payments->sum('amount');
                                                                    @endphp
                                                                    : {{ $dueAmount  }}
                                                                </td>
                                                            </tr>
