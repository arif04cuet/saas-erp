                    ...
                    <tr>
                        <td><br><br>
                            <div class="card-body" style="padding-left: 20px;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <strong>{{__('hm::booking-request.recipient_addressing')}} {{$roomBooking->requester->getName()}},<br> </strong>
                                        @if($roomBooking->status == "approved") {{__('hm::booking-request.approval_done_mail')}} @else {{__('hm::booking-request.approval_reject_mail')}} @endif
                                    </div>
                                </div>
                            </div>
                        </td>
