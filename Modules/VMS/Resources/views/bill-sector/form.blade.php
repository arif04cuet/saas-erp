...
<div class="col">
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                {!! Form::label('title_english', trans('vms::bill-sector.form_elements.title_english'), ['class' => 'form-label required']) !!}
        ...
        <div class="col-6">
            <div class="form-group">
                {!! Form::label('title_bangla', trans('vms::bill-sector.form_elements.title_bangla'), ['class' => 'form-label required']) !!}
                {!! Form::text('title_bangla', old('title_bangla') ?? null,
                    [
                        'class' => "form-control required",
                        "placeholder" => trans('vms::bill-sector.form_elements.title_bangla'),
                        'data-rule-maxlength'=> 500,
                        'data-msg-maxlength'=> trans('labels.max_length_validation_message',['length'=>500]),
                        'data-msg-required' => trans('labels.This field is required'),
                   ])
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                {!! Form::label('amount', trans('vms::vehicle.form_elements.price'), ['class' => 'form-label required']) !!}
                {!! Form::number('amount', old('amount') ?? null,
                    [
                        'class' => "form-control required",
...
<div class="form-actions text-center">
    ...
    <a class="btn btn-warning mr-1" role="button" href="{{route('vms.bill-sector.index')}}">
