        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        {!! Form::open(['route' =>  ['vms.trip.setting.update',$tripCalculationSetting],'class' => 'form trip-calculation-setting-form']) !!}
                        @method('put')
                        @include('vms::trip.setting.form')
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
...
@push('page-js')
    ...
    <script>
        $(document).ready(function () {
            validateForm('.trip-calculation-setting-form');
