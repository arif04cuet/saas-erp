    ...
    <div id="invoice-items-details" class="">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                {!! Form::label('name', trans('vms::maintenanceItem.table.item_name_en'),
                ['class' => 'form-label required']) !!}
                {!! Form::text('item_name_en', $page == "edit" ? $item->item_name_en : null, ['class' =>
                'form-control required',
                'placeholder' => trans('vms::maintenanceItem.table.item_name_en'),
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                {!! Form::label('item_name_bn_lavel', trans('vms::maintenanceItem.table.item_name_bn'), ['class' => 'form-label']) !!}
                {!! Form::text('item_name_bn', $page == "edit" ? $item->item_name_en : null, ['class' =>
                'form-control',
                'placeholder' => trans('vms::maintenanceItem.table.item_name_bn'),
                 'data-msg-required'=> __('labels.This field is required'),
                'data-rule-maxlength' => 255,
                'data-msg-maxlength'=> trans('labels.At most 255 characters')  ])!!}
                <!-- error message -->
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                'form-control',
                'placeholder' => trans('vms::maintenanceItem.table.item_short_name'),
                 'data-msg-required'=> __('labels.This field is required'),
        ...
        <div class="form-actions text-center">
            ...
            <a class="btn btn-warning mr-1" role="button" href="{{ route('vms.maintenance.item.index') }}">
