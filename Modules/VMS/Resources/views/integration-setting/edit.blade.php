        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        {!! Form::open(['route' =>  ['vms.integration.setting.update',$vmsIntegrationSetting],'class' => 'form vms-integration-form']) !!}
                        @method('put')
                        @include('vms::integration-setting.form')
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
...
@push('page-js')
    ...
    <script>
        $(document).ready(function () {
            validateForm('.vms-integration-form');
        })
    </script>
@endpush
