...
<div class="col">
    <div class="row cafeteria-journal-entry-repeater">
        <div class="table-responsive">
            <table class="table table-bordered text-center table-responsive-lg repeater-journal-items">
                ...
                <tbody data-repeater-list="cafeteria_journal_entries">
                ...
                @include('cafeteria::income-expense-entry.cash-bank-entry-form')
                </tfoot>
            </table>
