        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('cafeteria::income-expense.title') @lang('labels.show')</h4>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $cafeteriaJournal->journalEntry->reference ?? 0 }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('labels.date')</th>
                                        <td>{{ $cafeteriaJournal->journalEntry->date ?? 0 }}</td>
                                    </tr>
                                    <tr>
                                        <th>@lang('accounts::journal.history.fiscal_year')</th>
                                        <td>{{ $cafeteriaJournal->journalEntry->fiscalYear->name ?? 0 }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="col-md-12">
                            <h4 class="card-title" id="basic-layout-form">@lang('cafeteria::income-expense.title') @lang('labels.details')
                            </h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered alt-pagination text-center"
                                    ...
                                    <tbody>
                                        @foreach($cafeteriaJournal->journalEntry->journalEntryDetails as $journalEntryDetail)
                                        <tr>
                ...
                <div class="card-footer">
                    <div class="col-md-12">
                        <a href="{{route('income-expense-entries.index')}}" class="btn btn-danger">
