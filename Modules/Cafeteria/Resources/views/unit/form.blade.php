<div class="card-body">
    @if ($page == "create")
    {!! Form::open(['route' => 'units.store', 'class' => 'form unit-form']) !!}
    @else
    {!! Form::open(['route' => ['units.update', $unit->id ], 'class' => 'form unit-form']) !!}
    @method('PUT')
    @endif
    <div id="invoice-items-details" class="">
        <h4 class="form-section"><i class="la la-tag"></i>@lang('cafeteria::unit.title') @lang('labels.form')</h4>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('Name (Bangla)',  trans('cafeteria::unit.bangla_name'), ['class' => 'form-label required']) !!}
                    {!! Form::text('bn_name', $page == "edit" ? $unit->bn_name : null, ['class' =>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('en_name',  $page == "edit" ? $unit->en_name : null, ['class' =>
                    'form-control required',
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::textarea('remark',  $page == "edit" ? $unit->remark : null, ['class' => 'form-control', 'rows' => 2,
