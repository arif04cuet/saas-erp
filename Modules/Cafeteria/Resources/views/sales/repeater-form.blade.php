...
<div class="row">
    <div class="table-responsive col-sm-12">
        <table class="table table-bordered text-center sales-items">
            <thead>
                <tr>
                    <th width="20%">@lang('cafeteria::purchase-list.name')</th>
                    <th width="20%">@lang('cafeteria::purchase-list.quantity')</th>
            ...
            <tbody data-repeater-list="sales-entries">
                <!-- edit form start -->
                @if ($page == "edit")
                ...
                <tr data-repeater-item>
                    ...
                    @endphp
                    <td class="unit">{!! Form::select('unit_id', [$item->rawMaterial->unit->id => $unitName],
                        $item->rawMaterial->unit->id, ['class' => '
                    ...
                    <td> {!! Form::text('total_price', $item->total_price, ['class' =>
                ...
                <tr data-repeater-item>
                    ...
                    <td class="unit"> {!! Form::select('unit_id', [], null, ['class' => '
                        form-control unit-dropdown-select required',
                        'data-msg-required'=> __('labels.This field is required')
                        ])!!}
                    </td>
