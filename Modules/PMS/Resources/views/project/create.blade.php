                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">@lang('pms::project_proposal.project_creation')</h4>
...
@push('page-js')
    ...
    <script>
        $(document).ready(function() {
            ...
            //  workflow checkbox
            $('input[name=ignore_workflow]').on('ifChanged', function() {
                if ($(this).is(":checked")) {
                    $('.detail-proposal-div').hide();
                    $('select[name=project_detail_proposal_id]').next('.select2-container').hide();
                } else {
                    $('.detail-proposal-div').show();
                    $('select[name=project_detail_proposal_id]').next(".select2-container").show();
                }
            });
        });
    </script>
