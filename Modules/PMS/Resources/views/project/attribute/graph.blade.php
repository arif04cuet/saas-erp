<div class="card">
    ...
    <div class="card-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="project_chart_type">@lang('attribute.chart_types')</label>
                            <div class="row">
                                <div class="col">
                                    <div class="skin skin-flat">
                                        {!! Form::radio('project_chart_type', 'line', 'line') !!}
                                        <label>@lang('attribute.line')</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="skin skin-flat">
                                        {!! Form::radio('project_chart_type', 'horizontalBar') !!}
                                        <label>@lang('attribute.bar')</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="skin skin-flat">
                                        {!! Form::radio('project_chart_type', 'bar') !!}
                                        <label>@lang('attribute.column')</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="skin skin-flat">
                                        {!! Form::radio('project_chart_type', 'polarArea') !!}
        ...
        <div class="card-body chartjs">
            <canvas id="chartProject" height="500"></canvas>
        </div>
    </div>
</div>