...
@section('title', trans('pms::attribute_planning.enter_achieved'))
@push('page-css')
            ...
            <div class="col-sm-12 col-md-5">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('pms::attribute_planning.enter_achieved')</h4>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            {!! Form::open(['route' =>  ['project-attributes-achieved.store', $project->id], 'class' => 'form']) !!}
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i> Attribute Achieved Form</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::number('planning[' . $loop->iteration . '][achieved_value]', null, [
                                                'class' => 'form-control',
                                                'min' => 0,
                                                'required'
                                            ]) }}
