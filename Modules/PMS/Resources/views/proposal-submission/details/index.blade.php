                            ...
                            <div class="table-responsive">
                                <table class="proposal-submission-table table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">@lang('pms::project_proposal.vehicle_expense')</th>
                                    ...
                                    @foreach($proposals as $proposal)
                                        <tr>
                                            ...
                                            <td>{{ $vmsTripExpenses[$proposal->project_id] ?? 0 }}</td>
                                            <td>
                                                <span
                                            ...
                                            <td>
                                                <a class="round"
                                                   href="{{ route('project-detail-proposal-budget.index', $proposal->id) }}">
