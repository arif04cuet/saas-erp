...
@section('title', __('pms::budget.sector.title').' '.__('labels.show'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('pms::budget.sector.title') @lang('labels.show')</h4>
                ...
                <div class="card-content collapse show">
                    ...
                    <div class="card-footer">
                        <div class="col-md-12">
                            <a href="{{route('pms-sectors.edit', $sector->id)}}" class="btn btn-success">
                                <i class="la la-pencil"></i> @lang('labels.edit')
                            </a>
                            <a href="{{route('pms-sectors.index')}}" class="btn btn-danger">
