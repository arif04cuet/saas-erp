<div class="card-body">
    @if($page == 'create')
        {!! Form::open(['route' =>  'pms-sectors.store', 'class' => 'form', 'novalidate']) !!}
    @else
        {!! Form::open(['route' =>  ['pms-sectors.update', $sector->id], 'class' => 'form', 'novalidate']) !!}
        @method('PUT')
    @endif
    <div id="invoice-items-details" class="">
        <h4 class="form-section"><i
                class="la la-tag"></i>@lang('pms::budget.sector.form.title')</h4>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                    {!! Form::label('title_bangla', trans('pms::budget.sector.form.title_bangla'),
['class' => 'form-label required']) !!}
                    {{ Form::text('title_bangla', $page == 'create'? old('title_bangla') : $sector->title_bangla,
['class' => 'form-control', 'placeholder' => __('labels.title'), 'required', 'data-validation-required-message' =>
...
['class' => 'form-control', 'placeholder' => 'Title', 'maxlength' => 250, 'required', 'data-validation-required-message'
...
['class' => 'form-control', 'placeholder' => __('labels.details'), 'maxlength' => 250, 'rows' => 3]) }}
                </div>
                <!-- error message -->
        ...
        <!-- Sub Sectors -->
        <h4 class="form-section"><i
                class="la la-tag"></i>@lang('pms::budget.sector.form.sub_sector')</h4>
        <div class="row">
            <div class="table-responsive col-sm-12">
                <table class="table table-bordered repeater-sector-items">
                    <thead>
                    <tr class="text-center">
                        <th width="35%">@lang('pms::budget.sector.form.title_bangla')</th>
                            ...
                            <tr data-repeater-item>
                                <td>
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('title_bangla', $subSector->title_bangla, ['class' => 'form-control',
    'data-validation-required-message' => __('labels.This field is required'), 'maxlength' => 250])!!}
                                ...
                                <td>
                                    <div class="form-group">
                                        {!! Form::text('title_english', $subSector->title_english, ['class' => 'form-control',
    'data-validation-required-message' => __('labels.This field is required'), 'maxlength' => 250])!!}
                                        <div class="help-block"></div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    {!! Form::textarea('details', $subSector->details, ['class' => 'form-control',
'rows' => 2, 'maxlength' => 250])!!}
 ...
 'data-validation-required-message' => __('labels.This field is required'), 'maxlength' => 250])!!}
                        ...
                        <td>
                            {!! Form::textarea('details', null,['class' => 'form-control', 'rows' => 2, 'maxlength' => 250])!!}
                        </td>
    ...
    <div class="form-actions text-center">
        ...
        <a class="btn btn-warning mr-1" role="button" href="{{route('pms-sectors.index')}}">
