<div class="form-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="task_id" class="form-label required">{{ trans('pms::task.task_amount') }}</label>
                {{ Form::number('amount', isset($task) ? $task->amount : null, ['class' => 'form-control required' . ($errors->has('amount') ? ' is-invalid' : '')]) }}
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="task_id" class="form-label required">{{ trans('pms::task.task_amount_unit') }}</label>
                {{ Form::text('amount_unit', isset($task) ? $task->amount_unit : null, ['class' => 'form-control required' . ($errors->has('amount_unit') ? ' is-invalid' : '')]) }}
