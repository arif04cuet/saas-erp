                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tr>
                                <th>{{ trans('pms::project-activity.activity.activity_title') }}</th>
                                <td>{{ $taskable->name }}</td>
                            </tr>
                            ...
                            <tr>
                                <th>{{ trans('pms::task.task_amount') }}</th>
                                <td>{{$task->amount}}</td>
                            </tr>

                            <tr>
                                <th>{{ trans('pms::task.task_amount_unit') }}</th>
                                <td>{{$task->amount_unit}}</td>
                            </tr>
                        ...
                        <div class="form-actions">
                            <a href="{{ route('pms-activity-tasks.edit', [$project->id, $taskable->id, $task->id]) }}" class="btn btn-primary"><i
                                        class="ft-edit-2"></i> {{ trans('labels.edit') }}</a>

                            <a class="btn btn-warning mr-1" role="button" href="{{ route('pms-activity.show', [$project->id, $taskable->id]) }}">
