                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="form-actions">
                            <a href="{{ route('pms-activity-task-monthly-updates.edit', [$project->id, $monthlyUpdatable->id, $monthlyUpdate->id]) }}"
                               class="btn btn-primary"><i class="ft-edit-2"></i> {{trans('labels.edit')}}</a>
                            <a class="btn btn-warning mr-1" role="button"
                               href="{{ route("pms-activity.show", [$project->id, $monthlyUpdatable->id]) }}"> <i
