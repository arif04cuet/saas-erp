    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label>{{ trans('monthly-update.update_for') }}:
                    <span class="badge bg-blue-grey">{{ $monthlyUpdatable->title }}</span>
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('planning', isset($monthlyUpdate) ? $monthlyUpdate->planning : null, [
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('achievement', isset($monthlyUpdate) ? $monthlyUpdate->achievement : null, [
...
{{--    @else--}}
        <a href="{{ route('pms-activity.show', [$project->id, $monthlyUpdatable->id]) }}" class="btn btn-warning"><i
                    class="ft-x"></i> {{ trans('labels.cancel') }}</a>
{{--    @endif--}}
</div>
