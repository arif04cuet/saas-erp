                    ...
                    <div class="card-footer">
                        @if($isValidUser)
                            @if($proposal->status == "PENDING" && Request()->viewOnly != 1)
                                {!! Form::open(['route' => [ 'project-detail-proposal-submission.feedback',$shareConversationId], 'id' => 'review_form',  'enctype' => 'multipart/form-data', 'novalidate']) !!}
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('remarks', null, ['class' => 'form-control comment-input', 'rows' => 2,  'placeholder' => 'Remarks in Max 250 Characters', 'data-validation-required-message'=>trans('labels.This field is required')]) !!}
