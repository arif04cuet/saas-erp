                    ...
                    <div class="card-footer">
                        @if($isValidUser)
                            @if($proposal->status == 'PENDING' && Request()->viewOnly != 1)
                                {!! Form::open(['url'=> route('project-proposal-submitted-review-update', $proposal->id), 'novalidate','id' => 'review_form', 'class' => 'form']) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="designation_id" class="form-control">
                                                @foreach($ruleDesignations as $designation)
                                                    @if($designation->id != 73) <!-- In order to avoid risk, I did not remove it from Seeder -->
