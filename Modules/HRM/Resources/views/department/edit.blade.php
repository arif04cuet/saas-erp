            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="repeat-form"><i class="ft-tag"></i> @lang('hrm::department.edit_department')</h4>
                    ...
                    <div class="card-content collapse show" style="">
                        <div class="card-body">
                            {!! Form::model($department, ['url' =>  route('department.update', $department->id), 'method' => 'PUT', 'class' => 'form',' novalidate']) !!}
