...
@if($appraisal->status == "reported")
    @include('hrm::appraisal.partials.form.class.fourth.show.step-1')

    @include('hrm::appraisal.partials.form.class.fourth.show.step-2')

    @include('hrm::appraisal.partials.form.class.fourth.show.step-3')

    @include('hrm::appraisal.partials.form.class.fourth.show.step-4')

    @if(in_array($appraisal->type, ['second', 'third']))
        @include('hrm::appraisal.partials.form.class.fourth.show.step-7')
    @endif
@endif
...
@if($appraisal->status == "signed")
    ...
    @include('hrm::appraisal.partials.form.class.fourth.show.step-5')
@endif
...
@if($appraisal->status == "completed")
    ...
    @include('hrm::appraisal.partials.form.class.fourth.show.step-6')
@endif
