                    ...
                    <div class="form-group">
                        <div class="row skin skin-flat">
                            <div class="col-md-12 col-sm-12">
                                @if($signerEvaluationValue->value == '91-100')
                                ...
                                @endif
                                @if($signerEvaluationValue->value == '76-80')
                                ...
                                @endif
                                @if($signerEvaluationValue->value == '56-75')
                                ...
                                @endif
                                @if($signerEvaluationValue->value == '40-55')
                                ...
                                @endif
                                @if($signerEvaluationValue->value == "01-39")
