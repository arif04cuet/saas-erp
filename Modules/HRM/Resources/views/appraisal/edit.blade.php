            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="striped-row-layout-basic">@lang('hrm::appraisal.' . $appraisal->type . "_class_employee's") @lang('hrm::appraisal.title') @lang('labels.form')</h4>
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            @if($appraisal->type == "first")
                                @include('hrm::appraisal.partials.form.class.first-edit')
                            @else
                                @include('hrm::appraisal.partials.form.class.fourth-edit')
                            @endif
                        </div>
                    </div>
                </div>
