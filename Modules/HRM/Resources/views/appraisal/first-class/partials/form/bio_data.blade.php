    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('medical_officer_id', $medicalOfficers, null,
                    [
                        'placeholder' => trans('labels.select'),
                        'class' => 'form-control required'.($errors->has('medical_officer_id') ? ' is-invalid' : ''),
                        'id' => 'signer',
                        'data-msg-required' => trans('labels.This field is required'),
                    ])
                }}

                @if ($errors->has('medical_officer_id'))
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $errors->first('medical_officer_id') }}</strong>
                    </span>
                @endif
            </div>
        </div>
...
{{ Form::hidden('reporting_officer_id', auth()->user()->id) }}
