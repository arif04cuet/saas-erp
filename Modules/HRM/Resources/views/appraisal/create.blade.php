            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="" id="striped-row-layout-basic">
                            @lang('hrm::appraisal.' . $class . "_class_employee's") @lang('hrm::appraisal.title') @lang('labels.form')
                        </h3>
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            @if($class == "first")
                                @include('hrm::appraisal.partials.form.class.first')
                            @else
                                @include('hrm::appraisal.partials.form.class.fourth')
                            @endif
                        </div>
                    </div>
                </div>
