            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="repeat-form"><i class="ft-tag"></i> Edit Designation</h4>
                    ...
                    <div class="card-content collapse show" style="">
                        <div class="card-body">
                            {!! Form::model($designation, ['url' =>  route('designation.update', $designation->id), 'method' => 'PUT', 'class' => 'form',' novalidate']) !!}
