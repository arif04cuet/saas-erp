...
@section('title', trans('hrm::employee.religion.page.create.title'))
    ...
    <div class="col-xs-12 col-md-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
                    @lang('hrm::employee.religion.page.create.title')
                </h4>
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    {{ Form::open(
                        [
                            'route' => 'employees.religions.store',
                            'class' => 'form employee-religion-create-form',
                            'novalidate'
                        ]
                    ) }}
