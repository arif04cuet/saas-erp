...
<li class="nav-item ">
    <a class="nav-link " id="personal-tab" data-toggle="tab" href="#spouse-children"
       aria-controls="linkIcon12" aria-expanded="false"><i class="la la-archive"></i>
        @lang('hrm::spouse_children_info.tab_name')
    </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a class="nav-link " id="others-tab" data-toggle="tab" href="#others"
       aria-controls="linkIcon12" aria-expanded="false"><i class="la la-leanpub"></i> {{__('hrm::training.others')}}</a>
</li>
