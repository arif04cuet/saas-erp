<table class="master table">
    ...
    @if(optional($employee->employeePersonalInfo)->is_dead)
        <th>@lang('hrm::personal_info.date_of_death')</th>
        <td>
            @if(optional($employee->employeePersonalInfo)->date_of_death)
                {{ optional($employee->employeePersonalInfo)->date_of_death }}
            @endif
        </td>
    @endif
    <tr>
...
<a class="master btn btn-small btn-info" href="{{ route('employee.edit', $employee->id) . '/#personal' }}">@lang('labels.edit') </a>
