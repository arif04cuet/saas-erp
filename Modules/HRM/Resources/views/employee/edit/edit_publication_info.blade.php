<div class="repeater-default">
    ...
    <div data-repeater-list="publication">
        ...
        @if(isset($oldPublications['publication']) && count($oldPublications['publication'])>0)
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".type_of_publication") ? ' error' : '' }}">
                                        ...
                                        ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. Newsletters, Journals, Bulletins,  Reports etc',
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".author_name") ? ' error' : '' }}">
                                        ...
                                        {{ Form::text('author_name',  $publication['author_name'], ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. John Doe',
                                         'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".publication_title") ? ' error' : '' }}">
                                        ...
                                        ['class' => 'form-control form-control-sm', 'placeholder' => 'Population Database of Mexico',
                                        'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".publication_company") ? ' error' : '' }}">
                                        ...
                                        ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. IEEE', 'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. NYC']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".published_date") ? ' error' : '' }}">
                                        ...
                                        {{ Form::date('published_date',  $publication['published_date'], ['class' => 'form-control form-control-sm DatePicker',
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".source_link") ? ' error' : '' }}">
                                        ...
                                        <input type="url" name="source_link" value=""
                                               ...
                                               data-validation-required-message="{{trans('labels.This field is required')}}">
                                        {{--{{ Form::url('source_link',  $publication['source_link'], ['class' => 'form-control form-control-sm',--}}
                                        {{--'placeholder' => 'http://www.example.com/your-publication-link', 'data-error-message'=> 'Required in valid format']) }}--}}
                                        <div class="help-block"></div>
                                ...
                                {{ Form::hidden('id', isset($publication['id']) ? $publication['id'] : null) }}
            ...
            @endforeach
        @elseif(count($employee->employeePublicationInfo)>0)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. John Doe', 'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('publication_title', trans('hrm::publication.publication_title'), ['class' => 'required']) }}
                                        {{ Form::text('publication_title', $publication->publication_title, ['class' => 'form-control form-control-sm',
                                        'placeholder' => 'Population Database of Mexico', 'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('publication_company', trans('hrm::publication.publication_company'), ['class' => 'required']) }}
                                        {{ Form::text('publication_company',  $publication->publication_company, ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. IEEE',
                                        'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('publication_company_location', trans('hrm::publication.publication_company_location')) }}
                                        {{ Form::text('publication_company_location',  $publication->publication_company_location, ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. NYC']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('published_date', trans('hrm::publication.published_date'), ['class' => 'required']) }}
                                        {{ Form::text('published_date',  (!empty($publication->published_date))? date('d F, Y', strtotime($publication->published_date)) : '',
                                        ['class' => 'form-control form-control-sm DatePicker', 'placeholder' => 'Pick the date', 'data-validation-required-message'=> trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('source_link', trans('hrm::publication.published_source_link'), ['class' => 'required']) }}
                                        <input type="url" name="source_link" value="{{$publication->source_link}}"
                                               class="form-control form-control-sm" required
                                               placeholder='http://www.example.com/your-publication-link'
                                               data-validation-regex-regex="{{config('constants.regex.url')}}"
                                               data-validation-regex-message="{{trans('labels.invalid_url')}}"
                                               data-validation-required-message="{{trans('labels.This field is required')}}">
                                        {{--{{ Form::url('source_link',  $publication->source_link, ['class' => 'form-control form-control-sm',--}}
                                        {{--'placeholder' => 'http://www.example.com/your-publication-link', 'data-validation-required-message'=>trans('labels.This field is required')]) }}--}}
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. John Doe',
                                    'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                    <div class="help-block"></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. IEEE',
                                    'data-validation-required-message'=> trans('labels.This field is required')]) }}
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('publication_company_location', trans('hrm::publication.publication_company_location')) }}
                                    {{ Form::text('publication_company_location',  null, ['class' => 'form-control form-control-sm', 'placeholder' => 'eg. NYC']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::date('published_date',  null,
                                     ['class' => 'form-control form-control-sm DatePicker', 'placeholder' => 'Pick the date', 'data-validation-required-message'=>
