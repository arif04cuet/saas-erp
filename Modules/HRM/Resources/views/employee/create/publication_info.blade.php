                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->publicationError->has("publication.".$key.".source_link") ? ' error' : '' }}">
                                        ...
                                        ['class' => 'form-control form-control-sm', 'placeholder' => 'http://www.example.com/your-publication-link',
                                        'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                    ...
                    <div class=" col-md-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('source_link', trans('hrm::publication.published_source_link'), ['class' => 'required']) }}
                                    <input type="url" name="source_link" class="form-control form-control-sm" required
