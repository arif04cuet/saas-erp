...
@section('title', trans('hrm::job-circular.min_qualification'))
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <h3 class="form-section"><i class="ft-grid"></i> @lang('labels.new') @lang('hrm::job-circular.min_qualification')</h3>
                            @include('hrm::job-circular.minimum-qualifications.form')
                        </div>
                    </div>
                </div>
            </div>
...
@push('page-js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            let validator = $('.job-circular-qualification-form').validate({
                ignore: [],
                errorClass: 'danger',
