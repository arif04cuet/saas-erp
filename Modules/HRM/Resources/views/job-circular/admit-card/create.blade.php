...
@section('title', trans('hrm::job-circular.admit_card.title'))
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('hrm::job-circular.admit_card.create')</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <h3 class="form-section">
                                <i class="ft-grid"></i>
                                @lang('labels.new') @lang('hrm::job-circular.admit_card.title')
                            </h3>
                            @include('hrm::job-circular.admit-card.form', ['page' => 'create'])
                        </div>
                    </div>
                </div>
            </div>
...
@push('page-js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            let validator = $('.admit-card-form').validate({
                ignore: [],
                errorClass: 'danger',
            ...
            $('.admit-card-form').submit(function () {
