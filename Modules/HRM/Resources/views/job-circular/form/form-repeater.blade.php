            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('job_nature') ? ' error' : '' }}">
                        ...
                        {{ Form::select('designation_id', $designations, $page == "create" ? null : $jobCircular->designation_id,
                            [
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('salary_grade') ? ' error' : '' }}">
                        ...
                        {{ Form::select('salary_grade', $grades, null,
                            [
                                'class' => 'form-control select2 required',
                                'data-msg-required' => trans('labels.This field is required')
                            ])
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('max_age_divisional',
                            ...
                            ['class' => 'form-label ']) !!}
                        {!! Form::text('max_age_divisional_employee', null,
                        [
                            'class' => 'form-control ',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('max_age_quota_employee',
                            ...
                            ['class' => 'form-label requried']) !!}
                        {!! Form::text('max_age_quota_employee', null,
                        [
                            'class' => 'form-control required',
                            'placeholder' => trans('hrm::circular.max_age_quota'),
                            'max' => 100,
                            'data-msg-max'=> trans('hrm::circular.max_age_msg'),
                            'data-msg-required' => trans('labels.This field is required')
                        ]) !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('educational_requirement') ? ' error' : '' }}">
                        {{ Form::label('educational_requirement', trans('hrm::circular.educational_requirement'), ['class' => 'required']) }}
