...
@section('title', trans('hrm::job-circular.recruitment_exam.title') . ' ' . trans('labels.edit'))
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="repeat-form">
                            @lang('hrm::job-circular.recruitment_exam.title') @lang('labels.edit')
                        </h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            @include('hrm::job-circular.exam.form', ['page' => 'edit'])
                        </div>
                    </div>
                </div>
            </div>
