...
@section('title',trans('accounts::vendor.index'))
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('accounts::vendor.title') @lang('labels.list')</h4>
                        <a class="heading-elements-toggle"><i class="la la-ellipsis-h font-medium-3"></i></a>
                        <div class="heading-elements">
                            <a href="{{url(route('vendor.create'))}}" class="btn btn-primary btn-sm">
                                <i class="ft-plus white"></i>@lang('accounts::vendor.create')
                            </a>
                        </div>
                    </div>
