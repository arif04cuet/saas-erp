            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ trans('accounts::budget.revenue_budget') }}</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered alt-pagination" id="Example1">
                                    ...
                                    <tr>
                                        <th scope="row">1</th>
                                        <td>
                                            <a href="{{route('local-budget.show',1)}}">{{$fiscalYear}}</a>
                                        </td>
                                        <td>
                                            ...
                                            <span aria-labelledby="btnSearchDrop2"
                                                ...
                                                <a href="#" class="dropdown-item"><i class="ft-edit"></i>
                                                    {{trans('labels.edit')}}</a>
                                                <a href="#" class="dropdown-item"><i class="ft-eye"></i>
