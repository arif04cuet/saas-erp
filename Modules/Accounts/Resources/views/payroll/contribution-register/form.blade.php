@if($page == 'create')
    {!! Form::open(['route' =>  'contribution-register.store', 'class' => 'form salary-category-form', 'novalidate']) !!}
@else
    {!! Form::open(['route' => ['salary-category.update', $salaryRule->id], 'class' => 'salary-category-form']) !!}
    @method('PUT')
@endif
<h4 class="form-section"><i class="la la-tag"></i>@lang('accounts::salary-rule.contribution_register') @lang('labels.form')</h4>
<div class="row">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::textarea('description', $page == 'create' ? old('description') : $salaryCategory->description, ['class' => 'form-control',
            "placeholder" => "", 'rows'=> 3]) !!}
            <div class="help-block"></div>
