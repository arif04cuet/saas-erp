...
@section('title', trans('accounts::payroll.payslip_report.title'))
@section('content')
    <div class="container">
            ...
            <div class="col-md-12 col-xl-12 ">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            @include('accounts::payroll.payslip.report.form')
                        </div>
                    </div>
                </div>
                <div class="card">
...
@push('page-js')
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            ...
            let testUrl = `{{route('payslips.reports.filter')}}`;
            let data = $("#payslip-report-form").serialize();
            loadingInfo();
