{!! Form::open(['route' =>  'account-balance.filter', 'id' =>'account-balance-form','class' => 'form novalidate']) !!}

<h4 class="form-section"><i class="la la-tag"></i>@lang('accounts::account-balance.report')</h4>
