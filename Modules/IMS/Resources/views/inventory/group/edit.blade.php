...
@section('title', trans('ims::group.title') . ' ' . trans('labels.edit'))
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('ims::group.title') @lang('labels.edit')</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            @include('ims::inventory.group.form', ['page' => 'edit'])
                        </div>
                    </div>
                </div>
            </div>
