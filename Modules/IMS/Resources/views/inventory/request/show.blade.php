...
@section('content')
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">@lang('ims::inventory.inventory_request')</h4>
                    ...
                    <div class="col-5">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ __('ims::inventory.inventory_request_purposes.' . $inventoryRequest->purpose) }}
                                </td>
                            </tr>
                        </table>
                    </div>
