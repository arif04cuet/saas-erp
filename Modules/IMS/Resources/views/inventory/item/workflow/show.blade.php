    ...
    @if($shouldShowApproveRejectButton)
        <div class="form-actions text-center">
            <a class="btn btn-outline-success mr-1" role="button"
               href="{{route('inventory-item-request.workflow.change-status',[$inventoryItemRequest,\Modules\IMS\Entities\InventoryItemRequest::getStatus()['approved']])}}">
                <i class="la la-check-square"></i> @lang('labels.approve')
            </a>
            <a class="btn btn-outline-danger mr-1" role="button"
               href="{{route('inventory-item-request.workflow.change-status',[$inventoryItemRequest,\Modules\IMS\Entities\InventoryItemRequest::getStatus()['rejected']])}}">
