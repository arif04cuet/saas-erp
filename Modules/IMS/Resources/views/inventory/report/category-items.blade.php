...
@section('title', trans('ims::report.inventory.request.category_items.menu.title') .' '. trans('labels.list'))
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('ims::report.inventory.request.category_items.menu.title') @lang('labels.list')</h4>
...
@push('page-js')
    ...
    <script type="text/javascript">
        ...
        $('div.dataTables_length').append(`
            ...
            <input style="display: inline; width: 92%;" class= "form-control form-control-sm calendar-input" type="text" name="daterange" value="01/01/2018 - 01/15/2018" />
            </label>
        `).append(`
            <label style="margin-left: 20px;">
        ...
        dateRangePicker.on('apply.daterangepicker', function (e, picker) {
            ...
            $.fn.dataTable.ext.search.push(
                function (settings, data, dataIndex) {
                    ...
                    let date = moment(data[6], 'DD-MM-YYYY'),
                        categoryItemName = data[1],
                        status = false;
        ...
        categoryItemsList.on('change', function (e) {
            ...
            $.fn.dataTable.ext.search.push(
                function (settings, data, dataIndex) {
                    ...
                    let categoryItemName = data[1],
                        date = moment(data[6], 'DD-MM-YYYY'),
                        status = false;
